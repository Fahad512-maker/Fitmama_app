...
<div class="container">
                 ...
                 <div class="widget-content widget-content-area br-6 mt-5">
                        <table id="html5-extension" class="table table-hover non-hover" style="width:100%">
                                ...
                                <tbody>
                                      @if($exercise_videos->isNotEmpty())
                                    @foreach($exercise_videos as $key => $value)
                                    <tr>
                                        <td>{{ $key+1 }}</td>
                                        <td>{{ $value->title }}</td>
                                       <td><a href="{{ url('/exercise_videos/'.$value->id.'/edit') }}"><i data-feather="edit"></i></a>
                                           <a href="javascript:void(0)" class="delete_option" data-id="{{ $value->id }}"><i data-feather="trash"></i></a>
                                           <a href="{{ url('/exercise_videos/'.$value->id.'/show') }}"><i data-feather="eye"></i></a>
