@extends('admin.layouts.app' , ['class' => 'off-canvas-sidebar', 'category_name' => __('exercises'), 'page_name' => __('exercise_list')])
                        ...
                        <table id="html5-extension" class="table table-hover non-hover" style="width:100%">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>{{ $value->title }}</td>
                                        <td><img src="{{ $value->video->thumbnail }}" style="width:50%" class="img-fluid"></td>
                                       <td><a href="{{url('/exercise/'.$value->id.'/edit') }}"><i data-feather="edit"></i></a>
      ...
      <div class="modal-content">
        ...
        <div class="modal-footer">
          <button class="btn" data-dismiss="modal"><i class="flaticon-cancel-12"></i>Cancel</button>
                <a href="{{ url('/exercise/'.$value->id.'/delete') }}" class="btn" style="background-color:#1abc9c; color:white;">Delete</a>
        </div>
      </div>
