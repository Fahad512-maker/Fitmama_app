@extends('admin.layouts.app' , ['class' => 'off-canvas-sidebar', 'category_name' => __('susbcribe_question'), 'page_name' => __('profile_question_list')])
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                       ...
                                       <td><a href="{{ url('/profile_questions/'.$value->id.'/edit') }}"><i data-feather="edit"></i></a>
                                           <a href="" class=""><i data-feather="trash"></i></a>
