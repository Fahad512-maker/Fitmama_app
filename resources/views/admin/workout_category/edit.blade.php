...
<div class="container">
                            ...
                            <div class="statbox widget box box-shadow">
                                ...
                                <div class="widget-content widget-content-area mt-3">
                                    <form action="{{ url('/exercise_category/'.$exercisecategory->id.'/update') }}" method="POST" enctype="multipart/form-data">
                                    	@csrf
                                        @method('PUT')
                                    	<div class="row">
                                    	<div class="col-md-6">
                                    	<div class="form-group mb-3">
                                            <label>Name</label>
                                         <input type="text" name="name" placeholder="Enter Name" class="form-control" value="{{$exercisecategory->name}}">   
                                        </div>
                                    	</div>
                                    ...
                                    <form action="{{ url('/category_image/'.$exercisecategory->id.'/update') }}" method="POST" enctype="multipart/form-data">
                                        @csrf
                                        @method('PUT')
                                    <div class="card-body">
                                    <div class="row">
                                     <div class="col-md-5">
                                     <img src="{{ asset($exercisecategory->image) }}" class="img-fluid" width="200" height="200">
                                     </div>
