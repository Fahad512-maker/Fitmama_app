@extends('admin.layouts.app' , ['class' => 'off-canvas-sidebar', 'category_name' => __('recipes'), 'page_name' => __('edit_recipe_category')])
...
<div class="container">
                            ...
                            <div class="statbox widget box box-shadow">
                                ...
                                <div class="widget-content widget-content-area mt-3">
                                    <form action="{{ url('/recipe_category/'.$category->id.'/update') }}" method="POST" enctype="multipart/form-data">
                                    	@csrf
                                        @method('PUT')
                                    	<div class="row">
                                    	<div class="col-md-6">
                                    ...
                                    <form action="{{ url('/recipe_category_image/'.$category->id.'/update') }}" method="POST" enctype="multipart/form-data">
                                        @csrf
                                        @method('PUT')
                                    <div class="card-body">
                                    <div class="row">
                                     <div class="col-md-5">
                                     <img src="{{ asset($category->image) }}" class="img-fluid" width="200" height="200">
                                     </div>
                                     <div class="col-md-7">
