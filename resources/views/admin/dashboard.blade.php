@extends('admin.layouts.app' , ['class' => 'off-canvas-sidebar', 'category_name' => __('dashboard'), 'page_name' => __('dashboard')])
@section('content')
<!--  BEGIN CONTENT AREA  -->
        <div id="content" class="main-content">
            <div class="layout-px-spacing">
                ...
                <div class="row layout-top-spacing">
                    ...
                    <div class="card ml-3">
                       <h6 class="ml-3 mt-3 font-weight-bold" style="font-size: 23px; color: #1abc9c;">
                           <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-user"><path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"></path><circle cx="12" cy="7" r="4"></circle></svg>
                    Users</h6>
                       <div class="card-body">
                        <h6 class="float-right font-weight-bold" style="font-size: 25px;">{{ count($users) }}</h6>
                       </div> 
                    </div>
                    </div>
                    <div class="col-xl-4 col-lg-6 col-md-6 col-sm-6 col-12 layout-spacing">
                      <div class="card ml-3">
                       <h6 class="ml-3 mt-3 font-weight-bold" style="font-size: 23px; color: #1abc9c;">
                           ...
                           Subscribed Packages</h6>
                       <div class="card-body">
                        <h6 class="float-right font-weight-bold" style="font-size: 25px;">{{ count($packages) }}</h6>
                       </div> 
                    </div>
                    </div>
                    <div class="col-xl-4 col-lg-6 col-md-6 col-sm-6 col-12 layout-spacing">
                    <div class="card ml-3">
                       <h6 class="ml-3 mt-3 font-weight-bold" style="font-size: 25px; color: #1abc9c;">
                           <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-help-circle"><circle cx="12" cy="12" r="10"></circle><path d="M9.09 9a3 3 0 0 1 5.83 1c0 2-3 3-3 3"></path><line x1="12" y1="17" x2="12.01" y2="17"></line></svg>
                           Others</h6>
                       <div class="card-body">
                        <h6 class="float-right font-italic font-weight-bold" style="font-size: 25px;">0</h6>
                       </div> 
                    </div>
                    </div>
                    <!--<div class="col-xl-3 col-lg-6 col-md-6 col-sm-6 col-12 layout-spacing">-->
                    <!--<div class="card ml-3">-->
                    <!--   <h6 class="ml-3 mt-3 font-weight-bold" style="font-size: 30px; color: #1abc9c;">Users</h6>-->
                    <!--   <div class="card-body">-->
                    <!--    <h6 class="float-right font-weight-bold" style="font-size: 25px;">{{ count($users) }}</h6>-->
                    <!--   </div> -->
                    <!--</div>-->
 ...
 --}}
                   ...
                   <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 layout-spacing">
                        <div class="widget widget-table-two ml-3">

                            <div class="widget-heading">
                                <h4 class="font-weight-bold" style="font-size:20px;">Subscribed Packages</h4>
                            </div>
                            ...
                            <div class="widget-content">
                                <div class="table-responsive">
                                 ...
                                 <thead>
                                            <tr>
                                                <th><div class="font-weight-bold" style="font-size:18px;">Id</div></th>
                                                <th><div class="font-weight-bold" style="font-size:18px;">Susbscriber</div></th>
                                                <th><div class="font-weight-bold" style="font-size:18px;">Subscribed Package</div></th>
                                                <th><div class="font-weight-bold" style="font-size:18px;">Payment Type</div></th>
                                                <th><div class="font-weight-bold" style="font-size:18px;">Days Of Package</div></th>
                                            </tr>
                                        </thead>
                                <tbody>
                                            @if($packages)
                                            @foreach($packages as $key => $sub_package)
                                            <tr>
                                                <td>{{ $key+1 }}</td>
                                               <td><div class="font-weight-bold ml-3" style="color:#1abc9c">{{ $sub_package->user->name }}</div></td>
                                               <td><div class="font-weight-bold ml-3">{{ $sub_package->package->title }}</div></td>
                                               <td>
                                               @if($sub_package->package->onetime_payment_amount)
                                               <div class="font-weight-bold ml-3">£{{ $sub_package->package->onetime_payment_amount }} (One Time Amount)</div>
                                               @elseif($sub_package->package->per_month_payment_amount)
                                               <div class="font-weight-bold ml-3">£{{ $sub_package->package->per_month_payment_amount }} (Per Month Amount)</div></td>
                                               @endif
                                               <td><div class="font-weight-bold ml-5">{{ $sub_package->package->days }} Days</div></td>
